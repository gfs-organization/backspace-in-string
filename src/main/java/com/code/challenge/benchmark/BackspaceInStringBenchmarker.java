...
public class BackspaceInStringBenchmarker {
  ...
  private static final String CHAR_231 =
      "Lor#m ipsum dolor sit am#t, cons#ct#tur adipiscing #lit, s#d do #iusmod t#mpor incididunt ut labor# #t dolor#"
          + "magna aliqua. Ut #nim ad minim v#niam, quis nostrud #x#rcitation ullamco laboris nisi ut aliquip #x #a commodo cons#quat.";

  private static final String CHAR_445 =
      "#or#m ipsum do#or sit am#t, cons#ct#tur adipiscing ##it, s#d do #iusmod t#mpor incididunt ut #abor# #t do#or# "
          + "magna a#iqua. Ut #nim ad minim v#niam, quis nostrud #x#rcitation u##amco #aboris nisi ut a#iquip #x #a commodo cons#quat. "
          + "Duis "
  ...
  private static final String CHAR_3671 =
      "S#d ut p#rspiciatis und# omnis ist# natus #rror sit vo#uptat#m accusantium do#or#mqu# #audantium, totam r#m "
          + "ap#riam, #aqu# ipsa qua# ab i##o inv#ntor# v#ritatis #t quasi archit#cto b#ata# vita# dicta sunt #xp#icabo. N#mo #nim ipsam "
          + "vo#uptat#m quia vo#uptas sit asp#rnatur aut odit aut fu#it, s#d quia cons#quuntur ma#ni do#or#s #os qui ration# vo#uptat#m "
          + "s#qui"
          ...
          + "comp##t# account of th# syst#m, and #xpound th# actua# t#achin#s of th# #r#at #xp#or#r of th# truth, th# mast#r-bui#d#r of "
          + "human"
          + " happin#ss. No on# r#j#cts, dis#ik#s, or avoids p##asur# its##f, b#caus# it is p##asur#, but b#caus# thos# who do not know "
          + "how "
          + "to pursu# p##asur# rationa##y #ncount#r cons#qu#nc#s that ar# #xtr#m##y painfu#. Nor a#ain is th#r# anyon# who #ov#s or "
          + "pursu#s "
          + "or d#sir#s to obtain pain of its##f, b#caus# it is pain, but b#caus# occasiona##y circumstanc#s occur in which toi# and pain"
          + " can"
          + " procur# him som# #r#at p##asur#. To tak# a trivia# #xamp##, which of us #v#r und#rtak#s #aborious physica# #x#rcis#, #xc#pt"
          + " to "
          ...
          + "On th# oth#r hand, w# d#nounc# with ri#ht#ous indi#nation and dis#ik# m#n who ar# so b##ui##d and d#mora#iz#d by th# charms "
          + "of "
          + "p##asur# of th# mom#nt, so b#ind#d by d#sir#, that th#y cannot for#s## th# pain and troub## that ar# bound to #nsu#; and "
          + "#qua# "
          + "b#am# b##on#s to thos# who fai# in th#ir duty throu#h w#akn#ss of wi##, which is th# sam# as sayin# throu#h shrinkin# from "
          + "toi# "
          + "and pain. Th#s# cas#s ar# p#rf#ct#y simp## and #asy to distin#uish. In a fr## hour, wh#n our pow#r of choic# is untramm####d"
          + " and"
          + " wh#n nothin# pr#v#nts our b#in# ab## to do what w# #ik# b#st, #v#ry p##asur# is to b# w##com#d and #v#ry pain avoid#d. But "
          + "in "
  ...
  public static class MyState {
    ...
    public String shortString = RandomStringUtil.replaceRandomString(CHAR_231);
    public String mediumString = RandomStringUtil.replaceRandomString(CHAR_445);
    public String longString = RandomStringUtil.replaceRandomString(CHAR_3671);
  }
